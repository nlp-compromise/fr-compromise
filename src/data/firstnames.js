...
const male_names = {
  ...
  jes: 'se,us,s',
  al:
    'bert,an,len,fred,exander,ex,vin,lan,fredo,berto,ejandro,fonso,ton,,onzo,i,varo',
  ...
  ne: 'il,lson,al,d',
  t:
    'homas,imothy,odd,ony,heodore,im,yler,ed,yrone,aylor,erence,immy,oby,eddy,yson',
  ...
  b:
    'illy,obby,arry,ernard,ill,ob,yron,lake,ert,oyd,illie,laine,art,uddy,urton',
...
const female_names = {
  ...
  lil: 'lian,lie,a,y',
  ma:
    'ureen,ttie,xine,bel,e,deline,ggie,mie,ble,ndy,ude,yra,nuela,vis,gdalena,tilda',
  ...
  r: 'uth,ita,honda',
  s:
    'hirley,tephanie,ylvia,heila,uzanne,ue,tella,ophia,ilvia,ophie,tefanie,heena,ummer,elma,ocorro,ybil,imone',
